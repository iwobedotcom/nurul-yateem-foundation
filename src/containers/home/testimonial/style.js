...
export const SectionArea = styled.section`
    ...
    background-color: ${themeGet("colors.deepestgreen")};
    ${device.small} {
...
export const TitleWrap = styled.div`
    ...
    &:after {
        ...
        width: 100%;
        background: #8fae45;
        background-image: -ms-linear-gradient(-30deg, #3e8914 0%, #8fae45 100%);
        background: linear-gradient(-30deg, #3e8914 0%, #8fae45 100%);
    }
    .section-title {
        margin-bottom: 33px;
        max-width: 505px;
